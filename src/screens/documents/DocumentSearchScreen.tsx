...
type DocumentSearchScreenNavigationProp = StackNavigationProp<AppStackParamList, 'DocumentSearch'>;
...
const DocumentSearchScreen: React.FC = () => {
    ...
    const navigation = useNavigation<DocumentSearchScreenNavigationProp>();
    ...
    const handleSearch = async () => {
        ...
        setLoading(true);
        try {
            const response = await chatAPI.searchDocuments(query, {
                top_k: topK,
                language,
    ...
    const MemoizedResultItem = React.memo(({ item }: { item: DocumentResult }) => (
        ...
        >
            <View style={styles.resultHeader}>
                <Icon name="file-search" size={20} color={Colors.primary} />
            ...
            <FadeInView>
                {results.length > 0 ? (
                    ...
                    <View style={styles.emptyContainer}>
                        <Icon name="file-search-outline" size={64} color={Colors.mutedForeground} />
